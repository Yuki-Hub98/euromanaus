                ...
                return(
                    ...
                    <div className="w-full p-2">
                        <div className="w-full flex flex-row  gap-[3.7rem] mb-2 items-center"> 
                            ...
                            <Input className="w-40 " size="sm" labelPlacement="outside" autoComplete="off" value={dataFornecedor?.cepFornecedor || ''} maxLength={8} name={`cep${type}`}
                        ...
                        <div className="w-full flex flex-row  gap-2 mb-2 items-center"> 
                            <div className="flex flex-row gap-8 pl-1 w-[60%] items-center">
                                ...
                                <Input className="w-96" size="sm" autoComplete="off" value={dataFornecedor?.enderecoFornecedor || ''} labelPlacement="outside" name={`endereco${type}`}
                                onChange={(e) => {handleChange(e) }}/>
                            </div>
                            <label className='text-xs'>Número</label>
                            <Input className="w-24" size="sm" autoComplete="off" value={dataFornecedor?.numeroFornecedor || ''}  labelPlacement="outside" name={`numero${type}`} 
                            onChange={(e) => {handleChange(e)}}/>
                        </div>
                        ...
                        <div className="w-full flex flex-row mb-2 gap-2 items-center">
                            <div className="flex flex-row gap-12 pl-2 w-[60%] items-center">
                                ...
                                <Input className="w-96" size="sm" autoComplete="off" value={dataFornecedor?.bairroFornecedor} labelPlacement="outside" name={`bairro${type}`}
                                onChange={(e) => {handleChange(e)}}/>
                            </div>
                            <label className='text-xs pl-1'>Cidade</label>
                            <Input className="w-32" size="sm" autoComplete="off" value={dataFornecedor?.cidadeFornecedor || ''} labelPlacement="outside" name={`cidade${type}`} 
                            onChange={(e) => {handleChange(e)}}/>
                            <label className='text-xs'>UF</label>
                            <Input className="w-10" size="sm" autoComplete="off" value={dataFornecedor?.ufFornecedor || ''} labelPlacement="outside" name={`uf${type}`} 
                            onChange={(e) => {handleChange(e)}}/>
                        </div>
                    </div>
                    </>
            ...
            case "Representante":
                return(
                    ...
                    <div className="w-full p-2">
                        <div className=" w-full flex flex-row gap-[3.7rem] mb-2 items-center"> 
                            <label className='text-xs pl-1.5'>CEP</label>
                            <Input className="w-40 " size="sm" value={dataRepresentante?.cepRepresentante || ''} autoComplete="off" labelPlacement="outside" maxLength={8} name={`cep${type}`}
                            onChange={(e) => {handleChange(e)}}/>
                        ...
                        <div className=" w-full flex flex-row gap-2 mb-2 items-center"> 
                            <div className="flex flex-row gap-8 pl-1 w-[60%] items-center">
                                <label className='text-xs'>Endereço</label>
                                <Input className="w-96" size="sm" value={dataRepresentante?.enderecoRepresentante || ''} autoComplete="off" labelPlacement="outside" name={`endereco${type}`}
                                onChange={(e) => {handleChange(e)}}/>
                            </div>
                            <label className='text-xs'>Número</label>
                        ...
                        <div className=" w-full flex flex-row mb-2 gap-2 items-center">
                            <div className="flex flex-row gap-12 pl-2 w-[60%] items-center">
                                <label className='text-xs'>Bairro</label>
                                <Input className="w-96" size="sm" value={dataRepresentante?.bairroRepresentante || ''} autoComplete="off" labelPlacement="outside" name={`bairro${type}`}
                                onChange={(e) => {handleChange(e)}}/>
                            </div>
                            <label className='text-xs pl-1'>Cidade</label>
                            <Input className="w-32" size="sm" value={dataRepresentante?.cidadeRepresentante || ''} autoComplete="off" labelPlacement="outside" name={`cidade${type}`} 
                            onChange={(e) => {handleChange(e)}}/>
                            <label className='text-xs'>UF</label>
                            <Input className="w-10" size="sm" value={dataRepresentante?.ufRepresentante || ''} autoComplete="off" labelPlacement="outside" name={`uf${type}`} 
                            onChange={(e) => {handleChange(e)}}/>
                        </div>
                    </div>
                    </>
