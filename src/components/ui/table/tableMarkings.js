    ...
    switch (value) {
      ...
      return(
        ...
        <tbody>
          ...
          className={`border outline-none border-[#d9d9d9] text-[#2c2c2b] ${item.hasOwnProperty('etapaDeProducao') ? 'bg-[#2c2c2b] text-white' : 'bg-[#F7F7F7]'} ${focusedRow === index && item.hasOwnProperty('etapaDeProducao') ? 'bg-[#edca62b4]' : 'bg-[#2c2c2b]'}`} >
            <td
              className={`border outline-none border-[#d9d9d9] text-[#2c2c2b] ${item.hasOwnProperty('etapaDeProducao') ? 'bg-[#2c2c2b] text-white' : 'bg-[#F7F7F7]'} ${focusedRow === index && item.hasOwnProperty('etapaDeProducao') ? 'bg-[#edca62b4]' : 'bg-[#2c2c2b]'}`} >
              {item.codigo}
            </td>
            ...
            {item.etapaDeProducao ? 
              <td  onClick={() => handleCellClick(index)} 
                className={`border outline-none border-[#d9d9d9] text-[#2c2c2b] ${item.hasOwnProperty('etapaDeProducao') ? 'bg-[#2c2c2b] text-white cursor-pointer' : 'bg-[#F7F7F7]'} ${focusedRow === index && item.hasOwnProperty('etapaDeProducao') ? 'bg-[#edca62b4]' : 'bg-[#2c2c2b]'}`} >
                {item.etapaDeProducao}
              </td>
            :
              <td 
      ...
      return(
        ...
        <tbody>
          {data.map((item, index) => (
            <tr key={index}
            className={`border outline-none border-[#d9d9d9] text-[#2c2c2b] ${item.hasOwnProperty('etapaDeProducao') ? 'bg-[#2c2c2b] text-white' : 'bg-[#F7F7F7]'}`} >
              <td
                className={`border outline-none border-[#d9d9d9] text-[#2c2c2b] ${item.hasOwnProperty('etapaDeProducao') ? 'bg-[#2c2c2b] text-white' : 'bg-[#F7F7F7]'}`} >
                {item.codigo}
              </td>
              ...
              <td
                className={`border outline-none border-[#d9d9d9] cursor-pointer text-[#2c2c2b] ${item.hasOwnProperty('etapaDeProducao') ? 'bg-[#2c2c2b] text-white' : 'bg-[#F7F7F7]'}`} >
                {item.valorTotalRecurso || item.valorTotalItem}
              </td>
